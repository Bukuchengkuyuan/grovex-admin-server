package com.grovex.admin.controller;

import com.baomidou.mybatisplus.core.conditions.update.UpdateWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.grovex.admin.common.exception.GlobalException;
import com.grovex.admin.common.utils.ExceptionUtil;
import com.grovex.admin.common.utils.MessageSourceUtil;
...
public class TestController {
    ...
    public Result testRedisCacheable() {
        return Result.ok().data("item", userService.page(new Page<>(1,20)));
    }
